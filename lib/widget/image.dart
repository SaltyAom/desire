  ...
  Builder desire(String desires) {
    getDesire(BuildContext context) {
      ...
      final styles = [
        ...
        ...mapDesireBuilder<Image>(desirable, context),
      ].toList();
    ...
    return Builder(
      builder: (context) {
        ...
        return Image(
          ...
          opacity:
              mapDesire<Animation<double>, Image>(desires, (e) => e.opacity),
          colorBlendMode:
          ...
          matchTextDirection: mapDesire<bool, Image>(
              desires, (e) => e.matchTextDirection, false)!,
          gaplessPlayback:
