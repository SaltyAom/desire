...
InputDecoration _mergeInputDecoration(InputDecoration d1, InputDecoration d2) {
  return InputDecoration(
    ...
    floatingLabelBehavior: d2.floatingLabelBehavior ?? d1.floatingLabelBehavior,
    ...
    prefixIconConstraints: d2.prefixIconConstraints ?? d1.prefixIconConstraints,
    ...
    suffixIconConstraints: d2.suffixIconConstraints ?? d1.suffixIconConstraints,
    ...
    errorBorder:
        d2.errorBorder?.copyWith(borderSide: d1.errorBorder?.borderSide) ??
            d1.errorBorder,
    focusedBorder:
        d2.focusedBorder?.copyWith(borderSide: d1.focusedBorder?.borderSide) ??
            d1.focusedBorder,
    focusedErrorBorder:
        d2.focusedBorder?.copyWith(borderSide: d1.focusedBorder?.borderSide) ??
            d1.focusedBorder,
    disabledBorder: d2.disabledBorder
        ...
        d1.disabledBorder,
    enabledBorder:
        d2.enabledBorder?.copyWith(borderSide: d1.enabledBorder?.borderSide) ??
            d1.enabledBorder,
    border: d2.border?.copyWith(borderSide: d1.border?.borderSide) ?? d1.border,
    enabled: d2.enabled,
    ...
    return Builder(builder: (context) {
      ...
      return TextFormField(
          ...
          decoration: desires
              ...
              .whereType<InputDecoration>()
              .reduce((acc, e) => _mergeInputDecoration(acc, e)),
          keyboardType: mapDesire<TextInputType, TextField>(
              desires, (e) => e.keyboardType),
          textInputAction: mapDesire<TextInputAction, TextField>(
              desires, (e) => e.textInputAction),
          textCapitalization: mapDesire<TextCapitalization, TextField>(
              desires, (e) => e.textCapitalization, TextCapitalization.none)!,
          ...
          readOnly:
              mapDesire<bool, TextField>(desires, (e) => e.readOnly, false)!,
          toolbarOptions: mapDesire<ToolbarOptions, TextField>(desires, (e) => e.toolbarOptions),
          showCursor: mapDesire<bool, TextField>(desires, (e) => e.showCursor),
